    ...
    : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        // Item
        b.Entity<Item>().HasIndex(i => i.HouseholdId);
        ...
        b.Entity<ShoppingList>()
            .Property(x => x.Status)
            .HasDefaultValue(ShoppingListStatus.Suggested)
            .HasSentinel(ShoppingListStatus.Suggested);
        b.Entity<ShoppingListItem>()
            .Property(x => x.ReasonFlags)
            .HasDefaultValue(SuggestionFlags.None)
            .HasSentinel(SuggestionFlags.None);
    }
}
